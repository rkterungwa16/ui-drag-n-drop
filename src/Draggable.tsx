...
const Draggable = (props: DraggableProps) => {
    ...
    React.useEffect(() => {
        if (currentPosition.x && currentPosition.y) {
            draggableELement.current.style.top = (draggableELement.current.offsetTop - currentPosition.deltaY) + "px";
            draggableELement.current.style.left = (draggableELement.current.offsetLeft - currentPosition.deltaX) + "px";
        }
    }, [
        currentPosition,
        currentPosition.x,
